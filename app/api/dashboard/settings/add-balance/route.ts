...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      addBalancePaypalMethodTitle: settings.addBalancePaypalMethodTitle,
      addBalancePaypalMethodTitleEn: settings.addBalancePaypalMethodTitleEn,
      addBalancePaypalTransferInstruction: settings.addBalancePaypalTransferInstruction,
      addBalancePaypalTransferInstructionEn: settings.addBalancePaypalTransferInstructionEn,
      addBalancePaypalAccount: settings.addBalancePaypalAccount,
      ...
      addBalanceInstapayAccount: settings.addBalanceInstapayAccount,
...
export async function PUT(request: NextRequest) {
  ...
  try {
    await updateHomepageSettings({
      ...
      add_balance_paypal_method_title: norm(body.addBalancePaypalMethodTitle),
      add_balance_paypal_method_title_en: norm(body.addBalancePaypalMethodTitleEn),
      add_balance_paypal_transfer_instruction: norm(body.addBalancePaypalTransferInstruction),
      add_balance_paypal_transfer_instruction_en: norm(body.addBalancePaypalTransferInstructionEn),
      add_balance_paypal_account: norm(body.addBalancePaypalAccount),
      ...
      add_balance_instapay_transfer_instruction_en: norm(body.addBalanceInstapayTransferInstructionEn),
      add_balance_instapay_account: norm(body.addBalanceInstapayAccount),
